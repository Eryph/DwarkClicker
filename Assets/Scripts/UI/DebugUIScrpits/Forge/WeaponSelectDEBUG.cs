namespace DwarfClicker.UIDebug.Forge
{
	using Core.Data;
	...
	{
		#region Fields
		[SerializeField] private GameObject _quitPanelButton = null;

		[SerializeField] private WeaponSelectButtonDEBUG[] _weaponsSelectButtons;
		#endregion Fields
		...
		private void OnEnable()
		{
			...
			_quitPanelButton.SetActive(true);
		...
		{
			_quitPanelButton.SetActive(false);
